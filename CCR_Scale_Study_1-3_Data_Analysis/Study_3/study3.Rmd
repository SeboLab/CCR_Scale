...
#Put file path to Study3_data.csv below:
df <- read.csv("~/CCR_Scale/Data_Analysis/Data/Study3_data.csv", header=T)
...
#Put file path to Study3_qualitative_data.csv below:
df_coding <- read.csv("~/CCR_Scale/Data_Analysis/Data/Study3_qualitative_data.csv", header=T)
